  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={NAME + " — How LandingCritic handles your data and the compliance posture it maintains."} />
      </Head>
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="mt-3 text-slate-600">Paste your landing page copy; get a 5-point critique covering value prop, CTA, target user, proof, and pricing. For indie founders shipping without a copywriter.</p>
          <h2 className="mt-8 text-xl font-semibold text-slate-900">What we handle</h2>
          <p className="mt-2 text-slate-600">LandingCritic processes the text or configuration you submit to produce its output. We do not train public models on your submissions without explicit consent.</p>
