...
const howToSteps = [
  { name: 'Open LandingCritic', text: 'Go to the workspace and enter the inputs LandingCritic asks for.' },
  { name: 'Generate the draft', text: 'Run LandingCritic to get a structured plain-English result.' },
...
export default function Page() {
  ...
  const SHORT = "LandingCritic gives your landing page a blunt 5-point critique."
  return (
    <>
      <Head>
      ...
      <div className="min-h-screen bg-slate-50 text-slate-800">
        ...
        <main className="max-w-3xl mx-auto px-6 py-14">
          ...
          <p className="mt-3 text-lg font-semibold text-slate-900" data-geo-short-lead="1">LandingCritic gives your landing page a blunt 5-point critique.</p>
