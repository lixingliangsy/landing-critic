  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://landing-critic.lxsaihub.com/" />
      
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What is LandingCritic?", "acceptedAnswer": {"@type": "Answer", "text": "LandingCritic is a tool that gives your landing page a 5-point critique with a score and the top fix to make."}}, {"@type": "Question", "name": "What five points does it check?", "acceptedAnswer": {"@type": "Answer", "text": "Value prop, CTA, target user, proof, and pricing."}}, {"@type": "Question", "name": "Does it give a score?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. It scores the page out of 5 across the checklist."}}, {"@type": "Question", "name": "What is the priority fix?", "acceptedAnswer": {"@type": "Answer", "text": "It names the single highest-priority fix to do first."}}, {"@type": "Question", "name": "Who should use it?", "acceptedAnswer": {"@type": "Answer", "text": "Indie founders shipping without a copywriter who want an honest page critique."}}, {"@type": "Question", "name": "Is the output copy-ready?", "acceptedAnswer": {"@type": "Answer", "text": "The critique is copy-ready guidance you apply to your own page."}}]}` }} />
        </Head>
      ...
      <div className="min-h-screen bg-white text-slate-900">
        ...
        <section id="definition" className="py-20 bg-slate-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4">LandingCritic - definition</h2>
