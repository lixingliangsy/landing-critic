 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="landing-critic" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "landing-critic";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "landing-critic") + "_chat_session";
